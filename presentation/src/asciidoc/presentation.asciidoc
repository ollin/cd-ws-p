...
* Auslagern Passwörter aus +build.gradle+
...
TODO - wenn hooks eingefuehrt sind, dann musss kurz eine Diskussion stattfinden, warum der Name des builds in
der url keine Gute Idee ist.
