...
Oliver Nautsch <oliver.nautsch@inventage.com>
...
* integriere dieses Taggen und Pushen in gradle build von issumy
  ** Beispiel fuer erzeugen Image:
     *** es muss ein _Dockerfile_ erzeugt werden mit der Form:
[source, txt]
----
FROM ollin/vertx")
MAINTAINER Oliver Nautsch <oliver.nautsch@gmail.com>")
...
* http://semver.org/[Semantic Versioning]
  ...
  ** MINOR
  ** PATCH
* Jeder Commit ist ein potentieller Release! Kein SNAPSHOT in der Pipeline!
* ein Kompromiss wie es z.B. http://freecode.com/projects/h2/releases[H2] macht  (1.3.176, 1.4.177)

== Interation x - Performance Testing - hands on
...
* Baue Job in Jenkins und verhänge ihn richtig
