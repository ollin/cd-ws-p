...
- Verticle -- Code welcher von vert.x ausgeführt wird.
- Module   -- eine Vert.x Applikation besteht aus ein bis
mehreren Modulen. Module können mehrere verticals enthalten. Via modules
