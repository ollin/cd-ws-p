...
== Iteration 7 - Erzeugen eines Images - hands on
...
== Iteration 8 - Veröffentlichen eines Images
...
[source, bash]
----
docker tag inventage/huschihops:1.0 localhost:5000/inventage/huschihops:1.0
