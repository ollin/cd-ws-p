...
image::overview.with.draw.io.svg[overview,,,, link="images/overview.with.draw.io.svg"]
...
.. (wenn nicht, bitte Jenkins neu starten via Link - _Restart Safely_ -  und mit zweiter neuer Datei nochmals versuchen)
...
== Tools zum Aufbau der Schulungsumgebung
