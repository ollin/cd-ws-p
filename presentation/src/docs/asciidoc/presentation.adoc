...
. Wenn der build fertig ist öffne: http://
...
image::compose.png[Docker Compose,150,150,float="right", link="https://docs.docker.com/compose/"]
...
$ cd workspace
$ ./gradlew test
$ git commit -a -m "handson 6"
$ git push
----

* manuellen Schritt in Jenkins ausführen
...
image::tdd-and-bdd.jpg[bdd and tdd,,,float="right", link="https://watirmelon.blog/2012/01/31/introducing-the-software-testing-ice-cream-cone/"]
...
* Phase für Automated Acceptance Test
* Phase für Exploratives Testen
